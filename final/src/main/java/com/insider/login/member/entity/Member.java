...
//    @JoinColumn(name = "image_url", referencedColumnName = "member_image_no")
    ...
    public Member(int memberId, String name, String password, LocalDate employedDate, String address, String phoneNo, String memberStatus, String email, MemberRole role, Department department, Position position, String image) {
